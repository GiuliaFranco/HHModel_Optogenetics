...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 ChR2 /Users/giulia/Desktop/HHModel_Optogenetics/HH_implementation/src/Neuron/x86_64/Chrimson.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/giulia/Desktop/HHModel_Optogenetics/HH_implementation/src/Neuron/Chrimson.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
  "Chrimson.mod\n"
  ...
  "	Gd2 = 0.01                                  	 : ms^-1\n"
  "	Gr  = 0.000000667    	 : recovery rate ms^-1\n"
  "\n"
