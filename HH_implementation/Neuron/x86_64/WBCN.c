...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 WBCN /Users/giulia/Desktop/HHModel_Optogenetics/HH_implementation/src/Neuron/x86_64/WBCN.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 76 in file WBCN.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/giulia/Desktop/HHModel_Optogenetics/HH_implementation/src/Neuron/WBCN.mod";
static const char* nmodl_file_text = 
