...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 ca /Users/giulia/Desktop/FoutzEtAl2012/x86_64/ca.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lvm ) {
   ...
   a = 0.055 * 3.8 * efun ( _threadargscomma_ - ( 27.0 + _lvm ) / 3.8 ) ;
   b = 0.94 * exp ( ( - 75.0 - _lvm ) / 17.0 ) ;
   mtau = 1.0 / tadj / ( a + b ) ;
   minf = a / ( a + b ) ;
   a = 0.000457 * exp ( ( - 13.0 - _lvm ) / 50.0 ) ;
   b = 0.0065 / ( exp ( ( - _lvm - 15.0 ) / 28.0 ) + 1.0 ) ;
   htau = 1.0 / tadj / ( a + b ) ;
   hinf = a / ( a + b ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/giulia/Desktop/FoutzEtAl2012/ca.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
