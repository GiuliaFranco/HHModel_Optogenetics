...
#define qa qa_na16
 double qa = 6;
#define tadj_na16 _thread1data[0]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na16 /Users/giulia/Desktop/FoutzEtAl2012/x86_64/na16.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lvm ) {
   a = Ra * qa * efun ( _threadargscomma_ ( tha - _lvm ) / qa ) ;
   b = Rb * qa * efun ( _threadargscomma_ ( _lvm - tha ) / qa ) ;
   tadj = pow( q10 , ( ( celsius - temp ) / ( 10.0 ) ) ) ;
   mtau = 1.0 / tadj / ( a + b ) ;
   minf = a / ( a + b ) ;
   a = Rd * qi * efun ( _threadargscomma_ ( thi1 - _lvm ) / qi ) ;
   b = Rg * qi * efun ( _threadargscomma_ ( _lvm - thi2 ) / qi ) ;
   htau = 1.0 / tadj / ( a + b ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/giulia/Desktop/FoutzEtAl2012/na16.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "na16.mod\n"
